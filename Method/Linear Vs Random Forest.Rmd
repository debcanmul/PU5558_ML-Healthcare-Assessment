...
simple_rec <- knee_train %>%
  recipe(`Post-Op Q EQ5D Index` ~ `Age Band`,`Gender`,`Pre-Op Q EQ5D Index`,`Pre-Op Q EQ VAS`,`Knee Replacement Pre-Op Q Pain`:`Knee Replacement Pre-Op Q Score`) %>%
...
# Fit the two models (make sure you named the data split object knee_data_split)
